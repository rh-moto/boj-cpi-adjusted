...
EDUCATION_STEPS = [
    ...
    # 高等教育修学支援新制度（2020年4月開始）
    ("8040", "2020-04", 7.1),    # 105.3→98.2 大学授業料（国立）
    ("8060", "2020-04", 5.0),    # 103.8→98.7 大学授業料（私立）w=91
    ("8070", "2020-04", 5.1),    # 103.8→98.7 短期大学授業料（私立）
    ("8077", "2020-04", 9.1),    # 106.8→97.7 専修学校授業料（私立）
    # 保育所保育料
